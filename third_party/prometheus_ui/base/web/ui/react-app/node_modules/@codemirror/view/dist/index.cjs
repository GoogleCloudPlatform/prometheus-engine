...
function moveVisually(line, order, dir, start, forward) {
    ...
    if (nextSpan && nextSpan.level < span.level)
        return state.EditorSelection.cursor(nextSpan.side(!forward, dir) + line.from, 0, nextSpan.level);
    return state.EditorSelection.cursor(nextIndex + line.from, 0, span.level);
}
