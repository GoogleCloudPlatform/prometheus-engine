...
try {
    ;
    ({ parser, terms } = __.buildParserFile(readFileSync(file, "utf8"), { fileName: file, moduleStyle, includeNames, exportName }));
}
catch (e) {
    console.error(e instanceof __.GenError ? e.message : e.stack);
    process.exit(1);
}
if (out) {
