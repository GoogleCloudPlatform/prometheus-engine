...
require github.com/efficientgo/e2e v0.14.1-0.20260204162810-8c75b1e33ef9
...
replace (
	...
	github.com/prometheus/prometheus => github.com/GoogleCloudPlatform/prometheus v0.0.0-20260903071536-638bcf37f025 // v2.53.5-gmp.8-rc.1
	...
	// which breaks the pinned Prometheus v2.53.5 fork. Keeping client-go at v0.30.14 also requires
	// keeping matching v0.30.14 for apimachinery and api to avoid removed APIs and schema type mismatches.
