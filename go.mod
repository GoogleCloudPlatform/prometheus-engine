...
replace (
	// Unmask secrets
	github.com/prometheus/alertmanager => github.com/GoogleCloudPlatform/alertmanager v0.27.0-gmp.2-rc.1-unmasked
	// Unmask secrets
	github.com/prometheus/common => github.com/bernot-dev/prometheus-common v0.47.0-gmp.2
