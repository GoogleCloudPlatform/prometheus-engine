...
require (
	...
	github.com/prometheus/prometheus v0.313.0 // v3.13.0.
...
replace github.com/prometheus/prometheus => github.com/GoogleCloudPlatform/prometheus v0.0.0-20260903164310-65985e7c948b // release-3.13.0-gmp
