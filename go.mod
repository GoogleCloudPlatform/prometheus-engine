...
replace (
	// Alertmanager v0.30.0 pulls github.com/go-openapi/swag/loading v0.25.4, which transitively pins
	// github.com/go-openapi/testify/enable/yaml/v2 at v2.0.2.
	// That old version imports github.com/go-openapi/testify/v2/assert/yaml, which was removed/relocated
	// to enable/stubs/yaml in testify/v2 >= v2.5.0. Pinning enable/yaml/v2 to >= v2.7.0 (v2.8.0) fixes
	// the broken import path when used with newer testify/v2 releases.
	github.com/go-openapi/testify/enable/yaml/v2 => github.com/go-openapi/testify/enable/yaml/v2 v2.8.0
