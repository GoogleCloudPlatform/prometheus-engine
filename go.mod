...
require (
	...
	github.com/GoogleCloudPlatform/prometheus-engine/collector v0.0.0-00010101000000-000000000000
...
replace (
	// NOTE(bwplotka): Pin collector module to a version we host in the local directory.
	// This ensures our dependencies are compatibile with prometheus-engine main module.
	// See: go/gmp:fork-sunset for rationales.
	github.com/GoogleCloudPlatform/prometheus-engine/collector => ./collector

	// We need to pin it for now until we upgrade common to latest.
