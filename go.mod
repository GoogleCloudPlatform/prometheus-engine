...
replace (
	// Pinning to a temporary release.
	github.com/GoogleCloudPlatform/prometheus-engine/collector => github.com/GoogleCloudPlatform/prometheus-engine/collector v0.0.0-20250624131147-fc077d717968
