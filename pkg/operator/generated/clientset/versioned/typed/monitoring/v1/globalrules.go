...
func newGlobalRules(c *MonitoringV1Client) *globalRules {
	return &globalRules{
		client: c.RESTClient(),
	}
}
...
func (c *globalRules) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.GlobalRules, err error) {
	result = &v1.GlobalRules{}
	err = c.client.Get().
...
func (c *globalRules) List(ctx context.Context, opts metav1.ListOptions) (result *v1.GlobalRulesList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.GlobalRulesList{}
	err = c.client.Get().
		Resource("globalrules").
...
func (c *globalRules) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *globalRules) Create(ctx context.Context, globalRules *v1.GlobalRules, opts metav1.CreateOptions) (result *v1.GlobalRules, err error) {
	result = &v1.GlobalRules{}
	err = c.client.Post().
		Resource("globalrules").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *globalRules) Update(ctx context.Context, globalRules *v1.GlobalRules, opts metav1.UpdateOptions) (result *v1.GlobalRules, err error) {
	result = &v1.GlobalRules{}
	err = c.client.Put().
		Resource("globalrules").
...
func (c *globalRules) UpdateStatus(ctx context.Context, globalRules *v1.GlobalRules, opts metav1.UpdateOptions) (result *v1.GlobalRules, err error) {
	result = &v1.GlobalRules{}
	err = c.client.Put().
		Resource("globalrules").
		Name(globalRules.Name).
...
func (c *globalRules) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *globalRules) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *globalRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.GlobalRules, err error) {
	result = &v1.GlobalRules{}
