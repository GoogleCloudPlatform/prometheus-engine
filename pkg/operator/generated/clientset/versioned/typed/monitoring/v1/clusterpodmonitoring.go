...
func newClusterPodMonitorings(c *MonitoringV1Client) *clusterPodMonitorings {
...
func (c *clusterPodMonitorings) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.ClusterPodMonitoring, err error) {
	result = &v1.ClusterPodMonitoring{}
	err = c.client.Get().
...
func (c *clusterPodMonitorings) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ClusterPodMonitoringList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.ClusterPodMonitoringList{}
	err = c.client.Get().
		Resource("clusterpodmonitorings").
...
func (c *clusterPodMonitorings) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clusterPodMonitorings) Create(ctx context.Context, clusterPodMonitoring *v1.ClusterPodMonitoring, opts metav1.CreateOptions) (result *v1.ClusterPodMonitoring, err error) {
	result = &v1.ClusterPodMonitoring{}
	err = c.client.Post().
		Resource("clusterpodmonitorings").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *clusterPodMonitorings) Update(ctx context.Context, clusterPodMonitoring *v1.ClusterPodMonitoring, opts metav1.UpdateOptions) (result *v1.ClusterPodMonitoring, err error) {
	result = &v1.ClusterPodMonitoring{}
	err = c.client.Put().
		Resource("clusterpodmonitorings").
...
func (c *clusterPodMonitorings) UpdateStatus(ctx context.Context, clusterPodMonitoring *v1.ClusterPodMonitoring, opts metav1.UpdateOptions) (result *v1.ClusterPodMonitoring, err error) {
	result = &v1.ClusterPodMonitoring{}
	err = c.client.Put().
		Resource("clusterpodmonitorings").
		Name(clusterPodMonitoring.Name).
...
func (c *clusterPodMonitorings) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *clusterPodMonitorings) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *clusterPodMonitorings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ClusterPodMonitoring, err error) {
	result = &v1.ClusterPodMonitoring{}
