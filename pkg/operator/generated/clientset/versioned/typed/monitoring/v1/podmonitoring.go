...
func newPodMonitorings(c *MonitoringV1Client, namespace string) *podMonitorings {
...
func (c *podMonitorings) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.PodMonitoring, err error) {
	result = &v1.PodMonitoring{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *podMonitorings) List(ctx context.Context, opts metav1.ListOptions) (result *v1.PodMonitoringList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.PodMonitoringList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("podmonitorings").
...
func (c *podMonitorings) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *podMonitorings) Create(ctx context.Context, podMonitoring *v1.PodMonitoring, opts metav1.CreateOptions) (result *v1.PodMonitoring, err error) {
	result = &v1.PodMonitoring{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("podmonitorings").
...
func (c *podMonitorings) Update(ctx context.Context, podMonitoring *v1.PodMonitoring, opts metav1.UpdateOptions) (result *v1.PodMonitoring, err error) {
	result = &v1.PodMonitoring{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("podmonitorings").
...
func (c *podMonitorings) UpdateStatus(ctx context.Context, podMonitoring *v1.PodMonitoring, opts metav1.UpdateOptions) (result *v1.PodMonitoring, err error) {
	result = &v1.PodMonitoring{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("podmonitorings").
...
func (c *podMonitorings) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *podMonitorings) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *podMonitorings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.PodMonitoring, err error) {
	result = &v1.PodMonitoring{}
