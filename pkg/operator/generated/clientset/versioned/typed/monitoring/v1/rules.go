...
func newRules(c *MonitoringV1Client, namespace string) *rules {
	return &rules{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *rules) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.Rules, err error) {
	result = &v1.Rules{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("rules").
...
func (c *rules) List(ctx context.Context, opts metav1.ListOptions) (result *v1.RulesList, err error) {
...
func (c *rules) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *rules) Create(ctx context.Context, rules *v1.Rules, opts metav1.CreateOptions) (result *v1.Rules, err error) {
	result = &v1.Rules{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("rules").
...
func (c *rules) Update(ctx context.Context, rules *v1.Rules, opts metav1.UpdateOptions) (result *v1.Rules, err error) {
	result = &v1.Rules{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rules").
...
func (c *rules) UpdateStatus(ctx context.Context, rules *v1.Rules, opts metav1.UpdateOptions) (result *v1.Rules, err error) {
	result = &v1.Rules{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rules").
...
func (c *rules) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *rules) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *rules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.Rules, err error) {
	result = &v1.Rules{}
