...
func (c *MonitoringV1alpha1Client) ClusterPodMonitorings() ClusterPodMonitoringInterface {
...
func (c *MonitoringV1alpha1Client) Rules(namespace string) RulesInterface {
