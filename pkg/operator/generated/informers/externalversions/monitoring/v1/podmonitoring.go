	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.MonitoringV1().PodMonitorings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MonitoringV1().PodMonitorings(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *podMonitoringInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&monitoringv1.PodMonitoring{}, f.defaultInformer)
}

func (f *podMonitoringInformer) Lister() v1.PodMonitoringLister {
	return v1.NewPodMonitoringLister(f.Informer().GetIndexer())
}
