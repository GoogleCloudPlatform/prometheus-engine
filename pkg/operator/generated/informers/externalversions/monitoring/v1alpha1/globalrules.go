	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MonitoringV1alpha1().GlobalRules().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MonitoringV1alpha1().GlobalRules().Watch(context.TODO(), options)
			},
		},
		&monitoringv1alpha1.GlobalRules{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *globalRulesInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&monitoringv1alpha1.GlobalRules{}, f.defaultInformer)
}

func (f *globalRulesInformer) Lister() v1alpha1.GlobalRulesLister {
	return v1alpha1.NewGlobalRulesLister(f.Informer().GetIndexer())
}
