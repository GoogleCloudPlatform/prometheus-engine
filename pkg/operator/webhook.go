...
func mutatingWebhookConfig(name, namespace string, port int32, caBundle []byte, gvrs []metav1.GroupVersionResource, ors ...metav1.OwnerReference) *arv1.MutatingWebhookConfiguration {
	var (
		vwc = &arv1.MutatingWebhookConfiguration{
			// Note: this is a "namespace-less" resource.
			ObjectMeta: metav1.ObjectMeta{
				Name:            name,
				OwnerReferences: ors,
