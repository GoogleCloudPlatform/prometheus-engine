...
func main() {
	...
	}
	{
		...
		http.Handle("/api/v1/rules/test/test", http.NotFoundHandler()) // Magical endpoint used by Grafana to check whether a datasource has the ruler-api enabled. Should contain the words "page not found" in the response.
